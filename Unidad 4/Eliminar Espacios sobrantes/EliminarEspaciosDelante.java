...
public class EliminarEspaciosDelante
{
	...
	{		
		...
		/*indexOf, sirve para realisar busquedas de una palabra concreta y te da la posicion
		y si nos devuelve -1 es que no la encuentra
		Si no queremos problemas con mayus y minus, podemos poner un 
		cad1.toLowerCase antes del indexOf ya que convierte toda la cadena 1 en minuscula*/
		
		System.out.println(cad1.indexOf("Mancha"));
		
		/*Esto solo devuelve la primera vez que sale si quieres que te diga todos tienes que hacer
		un bucle*/
		...
		/* devuelve verdadero o falso si la cadena empieza con lo que le he pasado*/
